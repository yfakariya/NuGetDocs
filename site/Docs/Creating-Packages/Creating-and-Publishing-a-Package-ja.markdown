<!-- Revision: e69b7b05ad87d29150b37ebe217bd12ddcf0eebe 2011/12/28 13:03:05 -->
# パッケージの作成と公開
...
## 複数の .NET Framework のバージョンやプロファイルをサポートする
...
<a name="#powershell"></a>
## パッケージのインストール中と削除中に PowerShell スクリプトを自動実行する
